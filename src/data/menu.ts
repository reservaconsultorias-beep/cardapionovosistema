...
export const menuData: MenuItem[] = [
  {id: 'e-1',name: '61 - Bacon',ingredients: 'mozzarella farta e fatias de bacon crocante cozido.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-2',name: '62 - Calabresa',ingredients: 'mozzarella premium e calabresa defumada moída de alta qualidade.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais', imageUrl: '/62-calabresa.png'},
  {id: 'e-3',name: '63 - Calapiry',ingredients: 'combinação saborosa de calabresa defumada com requeijão catupiry legítimo.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-4',name: '64 - Carijó',ingredients: 'mozzarella premium, frango temperado e grãos de milho doce cozido.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-5',name: '65 - Carne',ingredients: 'delicioso e suculento recheio de carne bovina picada temperada e limão.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais', imageUrl: '/65-carne.png'},
  {id: 'e-6',name: '66 - Crocante',ingredients: 'mozzarella farta, pedacinhos de bacon, milho doce e finalização com batata palha.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-7',name: '67 - Fiambre com Queijo',ingredients: 'recheio misto prático com mozzarella e fiambre fatiado picadinho.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais', imageUrl: '/67-fiambrecomqueijo.png'},
  {id: 'e-8',name: '68 - Frango',ingredients: 'mozzarella premium de forno de pedra com peito de frango desfiado temperado.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-9',name: '69 - Frango com Catupiry',ingredients: 'frango desfiado temperado com uma camada generosa de catupiry suave.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-10',name: '70 - Frampalha',ingredients: 'mozzarella, frango suculento defumado, catupiry cremoso e batata palha crocante.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-11',name: '71 - Milho',ingredients: 'massa assada de esfiha com queijo mozzarella bem derretido e milho doce.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-12',name: '72 - Milho com Bacon',ingredients: 'mozzarella de forno, pedaços generosos de bacon e milho macio cozido.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais', imageUrl: '/72-milhocombacon.png'},
  {id: 'e-13',name: '73 - Tradicional',ingredients: 'recheio leve com mozzarella farta, fiambre fatiado e pedaços de tomate.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais', imageUrl: '/73-tradicional.png'},
  {id: 'e-14',name: '74 - Margherita',ingredients: 'mozzarella de excelente qualidade, rodelas picadas de tomate e manjericão fresco.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-15',name: '75 - Napolitana',ingredients: 'mozzarella cremosinha, tomate fresco picado e farta cobertura de parmesão ralado.',priceSingle: 1.99,category: 'esfihas-salgadas-tradicionais'},
  {id: 'e-16',name: '76 - Brócolis com Bacon',ingredients: 'cobertura de brócolis frescos cortados, mozzarella farta e pedaços de bacon crocante.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais', imageUrl: '/76-brocoliscombacon.png'},
  {id: 'e-17',name: '77 - Carbonara',ingredients: 'recheio especial de mozzarella cremosa, pedaços de bacon saboroso e queijo catupiry.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-18',name: '78 - Peperoni',ingredients: 'autêntico sabor de salame peperoni picante fatiado sobre cobertra de mozzarella.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-19',name: '79 - Rúcula com Tomate Seco',ingredients: 'mozzarella derretida no forno, folhas picadas de rúcula fresca e tomate seco artesanal.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-20',name: '80 - Strogonoff de Carne',ingredients: 'carne bovina tenra ao creme de estrogonofe culinário, champignon e batata palha.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais', imageUrl: '/80-strogonoffdecarne.png'},
  {id: 'e-21',name: '81 - Strogonoff de Frango',ingredients: 'peito de frango picadinho ao molho estrogonofe cremoso, champignon e batata palha.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-22',name: '82 - Queijo',ingredients: 'mistura refinada de mozzarella premium com creme de natas e salsa fresca picadinha.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais', imageUrl: '/82-queijo.png'},
  {id: 'e-23',name: '83 - 4 Queijos',ingredients: 'deliciosa fusão de mozzarella farta, parmesão gourmet, provolone fatiado e catupiry.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-24',name: '84 - 5 Queijos',ingredients: 'combinação perfeita de cinco queijos:  mozzarella, parmesão, provolone, gorgonzola real e catupiry.',priceSingle: 2.99,category: 'esfihas-salgadas-especiais'},
  {id: 'e-25',name: '85 - Banana com Canela',ingredients: 'mozzarella farta, canela em pó, açúcar confeiteiro e banana prata fatiada e cozida.',priceSingle: 3.5,category: 'esfihas-doces', imageUrl: '/85-bananacomcanela.png'},
  {id: 'e-26',name: '86 - Chocolate Branco',ingredients: 'mozzarella farta servida bem quente com cobertura rica de chocolate branco nobre.',priceSingle: 3.5,category: 'esfihas-doces', imageUrl: '/86-chocolatebranco.png'},
  {id: 'e-27',name: '87 - Chocolate Preto',ingredients: 'cobertura cremosa e farta de calda de chocolate de cacau preto sobre mozzarella.',priceSingle: 3.5,category: 'esfihas-doces', imageUrl: '/87-chocolatepreto.png'},
  {id: 'e-28',name: '88 - Nutella',ingredients: 'recheio dos sonhos com o legítimo creme de chocolate com avelãs Nutella e mozzarella.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-29',name: '89 - MM\'s',ingredients: 'esfiha de queijo mozzarella coberta com Nutella farta e repleta de coloridos confeitos MM\'s.',priceSingle: 3.5,category: 'esfihas-doces', imageUrl: '/89-mm.png'},
  {id: 'e-30',name: '90 - Leite Ninho - Nido',ingredients: 'base irresistível de Nutella premium coberta generosamente com o clássico Leite Ninho (Nido) em pó.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-31',name: '91 - Oreo Chocolate Branco',ingredients: 'cobertura cremosa de chocolate branco enriquecida com bolachas Oreo originais trituradas.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-32',name: '92 - Oreo Chocolate Preto',ingredients: 'calda de chocolate preto de cacau com abundantes farelos crocantes de biscoito Oreo.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-33',name: '93 - Prestígio',ingredients: 'cobertura deliciosa de chocolate preto nobre salpicada com coco ralado desidratado fino.',priceSingle: 3.5,category: 'esfihas-doces', imageUrl: '/93-prestigio.png'},
  {id: 'e-34',name: '94 - Sensação com Nutella',ingredients: 'camada de creme de avelã Nutella autêntico finalizada com fatias de morango fresco e maduro.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-35',name: '95 - Sensação com Chocolate Branco',ingredients: 'combinação fina de chocolate branco quente nobre derretido com morango em fatias.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-36',name: '96 - Sensação com Chocolate Preto',ingredients: 'calda quente artesanal de chocolate preto decorada com morangos frescos picados.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-37',name: '97 - Surpresa de Uva Verde Chocolate Branco',ingredients: 'chocolate branco nobre com metades suculentas de uvas verdes finas sem sementes.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-38',name: '98 - Surpresa de Uva Verde Chocolate Preto',ingredients: 'calda aveludada de chocolate preto nobre combinada com metades refrescantes de uva verde.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-39',name: '99 - Triângulo Amoroso',ingredients: 'visual lindo com metade chocolate preto, metade chocolate branco e morango fresco no centro.',priceSingle: 3.5,category: 'esfihas-doces'},
  {id: 'e-40',name: '100 - Banana com Nutella',ingredients: 'fatias deliciosas de banana prata fresca cobertas com o legítimo creme de avelã Nutella.',priceSingle: 3.5,category: 'esfihas-doces'},
